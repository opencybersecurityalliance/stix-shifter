...
class TestStixToQuery(unittest.TestCase, object):
    ...
    def test_event_count_query(self):
        ...
        queries = "{'query': '(_messagecount = \"21\")','fromTime': '20210128T122401','toTime': '20210725T125401'}"
        _test_query_assertions(query, queries)
    ...
    def test_time_observed_query(self):
        ...
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(_messagetime = \"2021-09-23T11:34:07.255Z\")','fromTime': '%s','toTime': '%s'}" \
                  % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_src_device_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(_collector = \"sumologic.domain.com\")','fromTime': '%s','toTime': '%s'}" \
                  % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_event_code_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(_messageid = \"12345678\")','fromTime': '%s','toTime': '%s'}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_event_module_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(_source = \"Linux System_3\")','fromTime': '%s','toTime': '%s'}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_custom_collector_id_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(_collectorid = \"12345678\")','fromTime': '%s','toTime': '%s'}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_user_id_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(id = \"12345678\")','fromTime': '%s','toTime': '%s'}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_user_account_login_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(email = \"abc@domain.com\")','fromTime': '%s','toTime': '%s'}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_user_display_name_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(displayName = \"abc def\")','fromTime': '%s','toTime': '%s'}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_user_account_created_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(createdAt = \"2021-09-23T11:34:07.255Z\")','fromTime': '%s','toTime': '%s'}" \
                  % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_user_account_last_login_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{'query': '(lastLoginTimestamp = \"2021-10-04T13:51:09.958Z\")','fromTime': '%s','toTime': '%s'}" \
                  % (from_time, to_time)
        _test_query_assertions(query, queries)

...
class TestStixToQuery(unittest.TestCase, object):
    def test_artifact_payload_query(self):
        stix_pattern = "[artifact:payload_bin = 'Sep 26 05:29:06 sumologic NetworkManager[677]: <info>  [1632614346.1076] dhcp4 (eth0)']"
        ...
        queries = '{"query": "(_raw = \\"Sep 26 05:29:06 sumologic NetworkManager[677]: <info>  [1632614346.1076] dhcp4 (eth0)\\")","fromTime": "%s","toTime": "%s"}' % (from_time, to_time)
    ...
    def test_event_code_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{\"query\": \"(_messageid = \\\"12345678\\\")\",\"fromTime\": \"%s\",\"toTime\": \"%s\"}" % (
            from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_event_module_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{\"query\": \"(_source = \\\"Linux System_3\\\")\",\"fromTime\": \"%s\",\"toTime\": \"%s\"}" % (
            from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_event_provider_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{\"query\": \"(_sourcecategory = \\\"linux/system\\\")\",\"fromTime\": \"%s\"," \
                  "\"toTime\": \"%s\"}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_custom_sourcename_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{\"query\": \"(_sourcename = \\\"/var/log/messages\\\")\",\"fromTime\": \"%s\"," \
                  "\"toTime\": \"%s\"}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_user_account_login_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{\"query\": \"(email = \\\"abc@domain.com\\\")\",\"fromTime\": \"%s\"," \
                  "\"toTime\": \"%s\"}" % (from_time, to_time)
        _test_query_assertions(query, queries)
    ...
    def test_user_display_name_query(self):
        ...
        query = translation.translate('sumologic', 'query', '{}', stix_pattern)
        _, from_time, to_time = query_constructor.convert_timestamp(query)
        queries = "{\"query\": \"(displayName = \\\"abc def\\\")\",\"fromTime\": \"%s\"," \
                  "\"toTime\": \"%s\"}" % (from_time, to_time)
        _test_query_assertions(query, queries)

...
def _translate_query(stix_pattern):
    return translation.translate('trustar', 'query', '{}', stix_pattern)
...
class TestStixtoQuery(unittest.TestCase, object):
    ...
    def test_searchterm(self):
        stix_pattern = "[x-trustar-report:searchTerm = 'redhat@gmail.com'] START t'2021-08-28T12:54:01.009Z' STOP t'2021-09-05T12:54:01.009Z'"
        translated_query = translation.translate('trustar', 'query', '{}', stix_pattern)
        test_query = ["{\"searchTerm\": \"redhat@gmail.com\", \"from\": 1630155241000, \"to\": 1630846441000}"]
        self._test_query_assertions(translated_query, test_query)

    def test_entitytype(self):
        stix_pattern = "[x-trustar-report:type = 'IP, MALWARE'] START t'2021-08-28T12:54:01.009Z' STOP t'2021-09-05T12:54:01.009Z'"
        translated_query = translation.translate('trustar', 'query', '{}', stix_pattern)
    ...
    def test_ipv4(self):
        ...
        self._test_query_assertions(query, test_query)

    def test_report(self):
        stix_pattern = "[x-trustar-report:report_details  = '9e509316-b8f2-428e-9981-0e552bb128bf'] START t'2021-08-28T12:54:01.009Z' STOP t'2021-09-05T12:54:01.009Z'"
        translated_query = translation.translate('trustar', 'query', '{}', stix_pattern)

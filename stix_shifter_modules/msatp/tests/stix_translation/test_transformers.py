...
def test_multiple_format_mac_list():
...
def test_to_msatp_directory():
    assert ToMSATPDirectoryPath.transform("c:\\a\\a\\a.exe") == "c:\\a\\a"


def test_severity_to_numeric_val():

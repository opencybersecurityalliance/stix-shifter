...
class TestTransform(unittest.TestCase):
    def test_virus_total_translation(self):
        ...
        ipv4_pattern = result_translator.get_pattern_from_json(data)

        data['data'] = url_data
        data['dataType'] = data_type_url
        url_pattern = result_translator.get_pattern_from_json(data)

        data['data'] = hash_sha1
        data['dataType'] = data_type_hash
        hash_pattern = result_translator.get_pattern_from_json(data)

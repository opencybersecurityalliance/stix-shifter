...
DATA1 = {'id': '2518268485253060642_52b1a353-2fd8-4c45-8f8a-94db98dca29d',
         ...
         'hostStates': [{'netBiosName': 'TEST-WINDOW',
                         'os': 'Windows', 'commandLine': '', 'name': 'services.exe',
                         'path': 'c:\\windows\\system32\\services.exe'},
                        {'accountName': 'test-window$',
         ...
         'userStates': [{'accountName': 'test-window$', 'domainName': 'WORKGROUP', 'emailRole': 'unknown',
                         'logonId': '0x3e7', 'onPremisesSecurityIdentifier': 'S-1-5-18',
                         'userPrincipalName': 'test-window$@TEST-WINDOW'}], 'event_count': '1'}
...
DATA2 = {'id': '2518267967999999999_13d684ad-1397-4db8-be04-9a7fe750bb1d',
         ...
         "networkConnections": [
             {"applicationName": "Microsoft", "destinationAddress": "61.23.79.168", "destinationDomain": None,
              "destinationLocation": None, "destinationPort": "22", "destinationUrl": None, "direction": None,
              "domainRegisteredDateTime": None, "localDnsName": None, "natDestinationAddress": None,
              "natDestinationPort": None,
              "natSourceAddress": None, "natSourcePort": None, "protocol": "tcp", "riskScore": None,
              "sourceAddress": "118.32.223.14",

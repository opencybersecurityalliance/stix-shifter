...
class TestQueryTranslator(unittest.TestCase):
    ...
    def test_oper_issuperset(self):
        ...
        assert query['error'] == "data mapping error : Unable to map the following STIX objects and properties: [['ipv4-addr:value'], ['ipv4-addr:value']] or Operators: [[IsSuperSet], [IsSuperSet]] to data source fields"

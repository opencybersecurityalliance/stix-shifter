...
@patch('stix_shifter_modules.azure_sentinel.stix_transmission.Log Analytics.connector.ClientSecretCredential')
@patch('stix_shifter_modules.azure_sentinel.stix_transmission.Log Analytics.api_client.APIClient.__init__')
class TestAzureSentinalConnection(unittest.TestCase, object):
    ...
    @patch('stix_shifter_modules.azure_sentinel.stix_transmission.Log Analytics.api_client.APIClient.ping_box')
    ...
    def test_ping_endpoint_exception(self, mock_ping_response, mock_api_client, mock_generate_token):
        ...
        assert ping_response[
                   'error'] == "azure_sentinel connector error => Resource not found for the segment \'alert\'."
    ...
    @patch(
        'stix_shifter_modules.azure_sentinel.stix_transmission.Log Analytics.connector.Connector.create_results_connection')
    ...
    @patch('stix_shifter_modules.azure_sentinel.stix_transmission.Log Analytics.api_client.APIClient.run_search')

...
class Testdb2ResultsToStix(unittest.TestCase):
   """
   class to perform unit test case for db2 translate results
   """
   ...
   def get_first_of_type(itr, typ):
       ...
       """
       return Testdb2ResultsToStix.get_first(itr, lambda o: isinstance(o, dict) and o.get('type') == typ)
   ...
   def test_common_prop(self):
       ...
       data = {'ProcessCreationEvents': {'EventTime': '2019-09-20T06:57:11.8218304Z',
                                         'UID': 4590968999797, 'SIP': '0.38.43.19', 'DIP': '32.50.3.170', 'PROTOCOL': 6,
       ...
       print("DATA SOURCE:      ", observed_data)
   ...
   def test_custom_property(self):
       ...
       observed_data = result_bundle_objects[1]
       props = data['ProcessCreationEvents']
       ...
       assert props['UID'] == 4590968999797
       assert props['SIP'] == '0.38.43.19'
       assert props['DIP'] == '32.50.3.170'
       assert props['PROTOCOL'] == 6
   ...
   def test_file_json_to_stix(self):
       ...
       file_obj = Testdb2ResultsToStix.get_first_of_type(objects.values(), 'file')
       ...
       directory_object = Testdb2ResultsToStix.get_first_of_type(objects.values(), 'directory')
   ...
   def test_process_json_to_stix(self):
       ...
       process_obj = Testdb2ResultsToStix.get_first_of_type(objects.values(), 'process')
   ...
   def test_network_json_to_stix(self):
       ...
       network_obj = Testdb2ResultsToStix.get_first_of_type(objects.values(), 'network-traffic')
   ...
   def test_network_json_to_stix_negative(self):
       ...
       network_obj = Testdb2ResultsToStix.get_first_of_type(objects.values(), 'file')
   ...
   def test_mac_json_to_stix(self):
       ...
       network_obj = Testdb2ResultsToStix.get_first_of_type(objects.values(), 'mac-addr')

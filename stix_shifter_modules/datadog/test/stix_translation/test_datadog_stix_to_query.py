...
class TestStixToQuery(unittest.TestCase, object):
    ...
    def test_ipv4_query(self, mock_time):
        ...
        queries = ['{"host": "abc.com", "start": 12344778, "end": 12345678}',
                   '{"id": 12345678, "start": 12344778, "end": 12345678}']
        assert query['queries'] == queries
    ...
    def test_event_id_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"id": 12345678, "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_priority_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"priority": "info", "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_title_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"title": "title", "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_text_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"text": "text", "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_device_name_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"device_name": "Windows", "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_source_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"source": "default,source", "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_monitor_id_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"monitor_id": 12345678, "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_tags_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"tags": "tags", "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_is_aggregate_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"unaggregated": "true", "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_alert_type_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"alert_type": "alert_type", "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_end_query(self):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"end": 1611836641, "start": 1611835741}'
        _test_query_assertions(query, queries)
    ...
    def test_time_observed_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"date_happened": 1611836641, "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)
    ...
    def test_query_from_multiple_observation_expressions_joined_by_AND(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"alert_type": "alert_type", "start": 12344778, "end": 12345678}',
                   '{"tags": "tags", "start": 12344778, "end": 12345678}']
        assert query['queries'] == queries
    ...
    def test_IN_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = '{"alert_type": ["alert_type", "default"], "start": 12344778, "end": 12345678}'
        _test_query_assertions(query, queries)

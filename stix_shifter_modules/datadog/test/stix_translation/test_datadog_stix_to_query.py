...
class TestStixToQuery(unittest.TestCase, object):
    ...
    def test_ipv4_query(self):
        stix_pattern = "[x-datadog-event:event_id = 1 AND x-datadog-event:event_id = 2 AND x-datadog-event:event_id = 4] AND [x-datadog-event:event_id = 6102786433786642503]"
        query = translation.translate('datadog', 'query', 'datadog', stix_pattern, options={"result_limit": 100})

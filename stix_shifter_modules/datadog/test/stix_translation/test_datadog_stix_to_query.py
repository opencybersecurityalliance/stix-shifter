...
class TestStixToQuery(unittest.TestCase, object):
    ...
    def test_ipv4_query(self, mock_time):
        ...
        queries = ['{"query": {"host": "abc.com", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   ...
                   '{"query": {"host": "abc.com", "start": 12345378, "end": 12345678}, "source": "events"}',
    ...
    def test_event_id_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"id": 12345678, "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"id_str": "12345678", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"id": 12345678, "start": 12345378, "end": 12345678}, "source": "events"}',
                   '{"query": {"id_str": "12345678", "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_priority_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"priority": "info", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"priority": "info", "start": 12345378, "end": 12345678}, "source": "events"}',]
        _test_query_assertions(query, queries)
    ...
    def test_title_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"title": "title", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"title": "title", "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_text_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"text": "text", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"text": "text", "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_device_name_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"device_name": "Windows", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"device_name": "Windows", "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_source_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"source": "default,source", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"source": "default,source", "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_monitor_id_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"monitor_id": 12345678, "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"monitor_id": 12345678, "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_tags_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"tags": "tags", "start": 12345378, "end": 12345678}, "source": "processes"}',
    ...
    def test_is_aggregate_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"unaggregated": "true", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"unaggregated": "true", "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_alert_type_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"alert_type": "alert_type", "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"alert_type": "alert_type", "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_start_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"start": 1611836641, "end": 12345678}, "source": "processes"}',
                   '{"query": {"start": 1611836641, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)

    def test_end_query(self):
        stix_pattern = "[x-ibm-finding:end = '2021-01-28T12:24:01.009Z']"
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"end": 1611836641, "start": 1611836341}, "source": "processes"}',
                   '{"query": {"end": 1611836641, "start": 1611836341}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_time_observed_query(self, mock_time):
        ...
        query = translation.translate('datadog', 'query', '{}', stix_pattern)
        queries = ['{"query": {"date_happened": 1611836641, "start": 12345378, "end": 12345678}, "source": "processes"}',
                   '{"query": {"date_happened": 1611836641, "start": 12345378, "end": 12345678}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_query_comparator_operator_AND_with_same_field(self):
        ...
        query = translation.translate('datadog', 'query', 'datadog', stix_pattern)
        queries = ['{"query": {"host": "abc.com", "start": 1611836641, "end": 1627217641}, "source": "processes"}',
                   '{"query": {"host": "abc.com", "start": 1611836641, "end": 1627217641}, "source": "events"}']
        _test_query_assertions(query, queries)
    ...
    def test_query_comparator_operator_AND_with_different_field(self):
        ...
        query = translation.translate('datadog', 'query', 'datadog', stix_pattern)
        queries = ['{"query": {"alert_type": "alert_type", "host": "abc.com", "start": 1611836641, "end": 1627217641}, "source": "processes"}',
                   '{"query": {"alert_type": "alert_type", "host": "abc.com", "start": 1611836641, "end": 1627217641}, "source": "events"}']
        _test_query_assertions(query, queries)

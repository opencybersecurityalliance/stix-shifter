...
class TestQueryTranslator(unittest.TestCase):
    ...
    def test_email_address_query(self):
        ...
        queries = ["{'queryPath': [{'requestedType': 'User', 'filters': [{'facetName': 'emailAddress', 'filterType': "
                   ...
                   " 'filterType': 'Between', 'values': [1638268646386, 1638268946386]}], 'isResult': True}], "
                   "'queryLimits': {"
                   "'groupingFeature': {'elementInstanceType': 'User', 'featureName': 'elementDisplayName'}}, "
                   "'perFeatureLimit': 1, 'totalResultLimit': 9999, 'perGroupLimit': 1, 'templateContext': "
                   "'CUSTOM', 'customFields': ['elementDisplayName', 'domain', 'ownerOrganization.name', "
                   "'ownerMachine', 'isLocalSystem', 'isAdmin', 'username', 'emailAddress', 'numberOfMachines', "
                   "'passwordAgeDays', 'privileges', 'comment', 'adCanonicalName', 'adCreated', 'adDisplayName', "
                   "'adLogonName', 'adMail', 'adMemberOf', 'adOU', 'adPrimaryGroupID', 'adSamAccountName', 'adTitle', "
                   ...
                   "{'facetName': 'adCreated', 'filterType': 'Between', 'values': [1638268646386, 1638268946386]}],"
    ...
    def test_query_from_multiple_comparison_expressions_joined_by_AND(self):
        stix_pattern = "[  x-oca-asset:name = 'bcybdw8888w10e2' AND domain-name:value= 'dl.delivery.mp.microsoft.com']"
        query = translation.translate('cybereason', 'query', '{}', stix_pattern)

        query['queries'] = _remove_timestamp_from_query(query['queries'])

        queries = ["{'queryPath': [{'requestedType': 'Connection', 'filters': [{'facetName': 'domainName', "
                   "'filterType': 'Equals', 'values': ['dl.delivery.mp.microsoft.com']}, {'facetName': 'creationTime', "
                   "'filterType': 'Between', 'values': [1638268753534, 1638269053534]}], 'connectionFeature': {"
                   "'elementInstanceType': 'Connection', 'featureName': 'ownerMachine'}}, {'requestedType': 'Machine', "
                   "'filters': [{'facetName': 'elementDisplayName', 'filterType': 'Equals', 'values': ["
                   "'bcybdw8888w10e2']}, {'facetName': 'lastSeenTimeStamp', 'filterType': 'Between', 'values': ["
                   "1638268753534, 1638269053534]}], 'isResult': True}], 'queryLimits': {'groupingFeature': {"
                   ...
                   "'suspiciousProcesses']}",
                   "{'queryPath': [{'requestedType': 'Connection', 'filters': [{'facetName': "
                   "'domainName', 'filterType': 'Equals', 'values': ['dl.delivery.mp.microsoft.com']}, {'facetName': "
                   "'creationTime', 'filterType': 'Between', 'values': [1638268753534, 1638269053534]}], "
                   ...
                   "'values': ['bcybdw8888w10e2']}, "
                   "{'facetName': 'lastSeenTimeStamp',"
                   " 'filterType': 'Between', 'values': [1638268753534, 1638269053534]}], 'isResult': True}],"
                   ...
                   "'suspiciousProcesses']}",
                   "{'queryPath': [{'requestedType': 'Connection', 'filters': [{'facetName': "
                   "'urlDomains', 'filterType': 'Includes', 'values': ['dl.delivery.mp.microsoft.com']}, {'facetName': "
                   "'creationTime', 'filterType': 'Between', 'values': [1638268753534, 1638269053534]}], "
                   "'connectionFeature': {'elementInstanceType': 'Connection', 'featureName': 'ownerMachine'}}, "
                   "{'requestedType': 'Machine', 'filters': [{'facetName': 'elementDisplayName', 'filterType': "
                   "'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': 'lastSeenTimeStamp', 'filterType': "
                   "'Between', 'values': [1638268753534, 1638269053534]}], 'isResult': True}], 'queryLimits': {"
    ...
    def test_multiple_observation_query(self):
        stix_pattern = "([file: hashes.MD5 = 'MD5' AND windows-registry-key:key = 'name' AND " \
                       ...
                       "x-cybereason-service:arguments = 'arg' AND x-cybereason-driver:file = 'dfile'] AND [ " \
                       "x-oca-asset: timezone = 4 AND x-cybereason-driver:machine ='username' ])START " \
                       "t'2019-10-01T00:00:00.030Z' STOP t'2021-10-07T00:00:00.030Z' "

        query = translation.translate('cybereason', 'query', '{}', stix_pattern)

        query['queries'] = _remove_timestamp_from_query(query['queries'])
        queries = ["{'queryPath': [{'requestedType': 'RegistryEvent', 'filters': "
                   "[{'facetName': 'detectionTimesNumber', 'filterType': 'Equals', 'values': [1]},"
                   " {'facetName': 'firstTime', 'filterType': 'Between', 'values': [1569888000030, 1633564800030]}],"
                   " 'connectionFeature': {'elementInstanceType': 'RegistryEvent', 'featureName': 'registryEntry'}}, "
                   "{'requestedType': 'Autorun', 'filters': [{'facetName': 'elementDisplayName', 'filterType': "
                   "'Equals', 'values': ['name']}, {'facetName': 'endTime', 'filterType': 'Between', 'values': ["
                   "1569888000030, 1633564800030]}], 'connectionFeature': {'elementInstanceType': 'Autorun', "
                   "'featureName': 'dependInFile'}}, {'requestedType': 'File', 'filters': [{'facetName': 'md5String', "
                   "'filterType': 'Equals', 'values': ['MD5']}, {'facetName': 'createdTime', 'filterType': 'Between', "
                   "'values': [1569888000030, 1633564800030]}], 'connectionFeature': {'elementInstanceType': "
                   "'Driver', 'featureName': 'file'}, 'isReversed': True}, {'requestedType': 'Driver', 'filters': [{"
                   "'facetName': 'file', 'filterType': 'Equals', 'values': ['dfile']}, {'facetName': 'endTime', "
                   "'filterType': 'Between', 'values': [1569888000030, 1633564800030]}], 'connectionFeature': {"
                   "'elementInstanceType': 'Driver', 'featureName': 'service'}}, {'requestedType': 'Service', "
                   "'filters': [{'facetName': 'binaryFile', 'filterType': 'Equals', 'values': ['sfile']}, "
                   "{'facetName': 'commandLineArguments', 'filterType': 'Equals', 'values': ['arg']}, {'facetName': "
                   "'endTime', 'filterType': 'Between', 'values': [1569888000030, 1633564800030]}], "
                   "'connectionFeature': {'elementInstanceType': 'Service', 'featureName': 'driver'}}, "
                   ...
                   "'isSuspiciousOrHasSuspiciousProcessOrFile', 'maliciousTools', 'maliciousProcesses', "
                   "'suspiciousProcesses']}",
                   "{'queryPath': [{'requestedType': 'RegistryEvent', 'filters': [{"
                   "'facetName': 'detectionTimesNumber', 'filterType': 'Equals', 'values': [1]}, {'facetName': "
                   "'firstTime', 'filterType': 'Between', 'values': [1569888000030, 1633564800030]}], "
                   "'connectionFeature': {'elementInstanceType': 'RegistryEvent', 'featureName': 'registryEntry'}}, "
                   "{'requestedType': 'Autorun', 'filters': [{'facetName': 'elementDisplayName', 'filterType': "
                   "'Equals', 'values': ['name']}, {'facetName': 'endTime', 'filterType': 'Between', 'values': ["
                   "1569888000030, 1633564800030]}], 'connectionFeature': {'elementInstanceType': 'Autorun', "
                   ...
                   "'filterType': 'Between', 'values': [1569888000030, 1633564800030]}], 'connectionFeature': {"
                   "'elementInstanceType': 'Driver', 'featureName': 'service'}}, {'requestedType': 'Service', "
                   "'filters': [{'facetName': 'oldBinaryFile', 'filterType': 'Equals', 'values': ['sfile']}, "
                   "{'facetName': 'commandLineArguments', 'filterType': 'Equals', 'values': ['arg']}, {'facetName': "
                   "'endTime', 'filterType': 'Between', 'values': [1569888000030, 1633564800030]}], "
                   "'connectionFeature': {'elementInstanceType': 'Service', 'featureName': 'driver'}}, "
                   "{'requestedType': 'Driver', 'filters': [{'facetName': 'ownerMachine', 'filterType': 'Equals', "
    ...
    def test_invalid_boolean_value(self):
        stix_pattern = "[x-cybereason-user:is_admin = '2']"
        result = translation.translate('cybereason', 'query', '{}', stix_pattern)
        assert result['success'] is False
    ...
    def test_boolean_true_value_query(self):
        stix_pattern = "[x-cybereason-user:is_admin = 'TRUE']"
        query = translation.translate('cybereason', 'query', '{}', stix_pattern)
        query['queries'] = _remove_timestamp_from_query(query['queries'])
    ...
    def test_boolean_false_value_query(self):
        stix_pattern = "[x-cybereason-user:is_admin = '0']"
        query = translation.translate('cybereason', 'query', '{}', stix_pattern)
        query['queries'] = _remove_timestamp_from_query(query['queries'])
        queries = ["{'queryPath': [{'requestedType': 'User', 'filters': [{'facetName': 'isAdmin', 'filterType': "
    ...
    def test_not_include_filter_query(self):
        ...
        queries = ["{'queryPath': [{'requestedType': 'Connection', 'filters': [{'facetName': 'domainName', "
                   ...
                   "'creationTime', 'filterType': 'Between', 'values': [1638190604059, 1638190904059]}], 'isResult': "
                   "True}], 'queryLimits': {'groupingFeature': {'elementInstanceType': 'Connection', 'featureName': "
                   "'elementDisplayName'}}, 'perFeatureLimit': 1, 'totalResultLimit': 9999, 'perGroupLimit': 1, "
                   "'templateContext': 'CUSTOM', 'customFields': ['elementDisplayName', 'direction', "
                   "'ownerMachine', 'ownerProcess', 'serverPort', 'serverAddress', 'portType', "
                   ...
                   "'remoteAddress', 'urlDomains']}",
                   "{'queryPath': [{'requestedType': 'Connection', 'filters': [{"
                   "'facetName': 'urlDomains', 'filterType': 'NotIncludes', 'values': ["
                   "'dl.delivery.mp.microsoft.com']}, "
                   "{'facetName': 'creationTime', 'filterType': 'Between', 'values': [1638190604059, 1638190904059]}],"
                   " 'isResult': True}], 'queryLimits': {"
                   "'groupingFeature': {'elementInstanceType': 'Connection', 'featureName': 'elementDisplayName'}}, "
                   "'perFeatureLimit': 1, 'totalResultLimit': 9999, 'perGroupLimit': 1, 'templateContext': "
                   "'CUSTOM', 'customFields': ['elementDisplayName', 'direction', 'ownerMachine', 'ownerProcess', "
    ...
    def test_creation_with_in_operator_query(self):
        stix_pattern = "[x-oca-event:created IN ('2020-11-01T08:43:10.003Z') ]"
        query = translation.translate('cybereason', 'query', '{}', stix_pattern)
        query['queries'] = _remove_timestamp_from_query(query['queries'])
        queries = ["{'queryPath': [{'requestedType': 'Process', 'filters': [{'facetName': 'creationTime',"
                   " 'filterType': 'Equals', 'values': [1604220190003]},"
                   " {'facetName': 'creationTime', "
                   "'filterType': 'Between', 'values': [1640860905893, 1640861205893]}], 'isResult': True}], "
                   "'queryLimits': {'groupingFeature': {"
                   "'elementInstanceType': 'Process', 'featureName': 'elementDisplayName'}}, 'perFeatureLimit': 1, "
                   "'totalResultLimit': 9999, 'perGroupLimit': 1, 'templateContext': 'CUSTOM', 'customFields': ["
                   "'elementDisplayName', 'creationTime', 'endTime', 'commandLine', "
    ...
    def test_observation_with_invalid_link_between_element(self):
        stix_pattern = "[x-cybereason-connection:port_type LIKE 'HTTP' AND x-oca-event:file[*] LIKE 'sbsimulation']"
        result = translation.translate('cybereason', 'query', '{}', stix_pattern)
        assert result['success'] is False

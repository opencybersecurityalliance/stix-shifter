...
class TestQueryTranslator(unittest.TestCase):
    ...
    def test_query_from_multiple_comparison_expressions_joined_by_AND(self):
        ...
        queries = ["{'queryPath': [{'requestedType': 'Connection', 'filters': [{'facetName': 'domainName', "
                   "'filterType': 'Equals', 'values': ['dl.delivery.mp.microsoft.com']}, {'facetName': "
                   "'creationTime', 'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], "
                   ...
                   "'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': 'lastSeenTimeStamp', "
                   "'filterType': 'Between', 'values': [1643024885488, 1643025185488]}],"
                   " 'isResult': True}], 'queryLimits': {"
                   ...
                   "'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], 'isResult': True}], "
                   "'queryLimits': {"
                   "'groupingFeature': {'elementInstanceType': 'Machine', 'featureName': 'elementDisplayName'}}, "
                   "'perFeatureLimit': 1, 'totalResultLimit': 9999, 'perGroupLimit': 1, 'templateContext': 'CUSTOM', "
                   "'customFields': ['elementDisplayName', 'mountPoints', 'processes', 'services', 'logonSessions', "
                   ...
                   "'suspiciousProcesses']}",
                   "{'queryPath': [{'requestedType': 'Connection', 'filters': [{'facetName': "
                   "'urlDomains', 'filterType': 'Includes', 'values': ['dl.delivery.mp.microsoft.com']}, "
                   "{'facetName': 'creationTime', 'filterType': 'Between', 'values': [1643024885488, "
                   "1643025185488]}], 'connectionFeature': {'elementInstanceType': 'Connection', 'featureName': "
                   "'ownerMachine'}}, {'requestedType': 'Machine', 'filters': [{'facetName': 'elementDisplayName', "
                   "'filterType': 'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': 'lastSeenTimeStamp', "
                   "'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], 'isResult': True}], "
                   ...
                   "{'queryPath': [{'requestedType': 'Connection', 'filters': [{'facetName': "
                   "'urlDomains', 'filterType': 'Includes', 'values': ['dl.delivery.mp.microsoft.com']}, "
                   "{'facetName': 'creationTime', 'filterType': 'Between', 'values': [1643024885488, 1643025185488]}],"
                   " 'connectionFeature': {'elementInstanceType': 'Connection', 'featureName': "
                   "'ownerMachine'}}, {'requestedType': 'Machine', 'filters': [{'facetName': 'adDisplayName', "
                   "'filterType': 'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': 'lastSeenTimeStamp', "
                   "'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], 'isResult': True}], "
                   "'queryLimits': {'groupingFeature': {'elementInstanceType': 'Machine', 'featureName': "
                   "'elementDisplayName'}}, 'perFeatureLimit': 1, 'totalResultLimit': 9999, 'perGroupLimit': 1, "
                   ...
                   "{'facetName': 'creationTime', 'filterType': 'Between', 'values': [1643024885488, 1643025185488]}],"
                   " 'connectionFeature': {'elementInstanceType': 'Connection', 'featureName': "
                   "'ownerMachine'}}, {'requestedType': 'Machine', 'filters': [{'facetName': 'adCanonicalName', "
                   "'filterType': 'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': 'lastSeenTimeStamp', "
                   "'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], 'isResult': True}], "
                   "'queryLimits': {'groupingFeature': {'elementInstanceType': 'Machine', 'featureName': "
                   "'elementDisplayName'}}, 'perFeatureLimit': 1, 'totalResultLimit': 9999, 'perGroupLimit': 1, "
                   ...
                   "'elementDisplayName', 'filterType': 'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': "
                   "'domainFqdn', 'filterType': 'Equals', 'values': ['dl.delivery.mp.microsoft.com']}, {'facetName': "
                   "'lastSeenTimeStamp', 'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], "
                   ...
                   "'suspiciousProcesses']}",
                   "{'queryPath': [{'requestedType': 'Machine', 'filters': [{'facetName': "
                   "'adDisplayName', 'filterType': 'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': "
                   "'domainFqdn', 'filterType': 'Equals', 'values': ['dl.delivery.mp.microsoft.com']}, {'facetName': "
                   "'lastSeenTimeStamp', 'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], "
                   "'isResult': True}], 'queryLimits': {'groupingFeature': {'elementInstanceType': 'Machine', "
                   "'featureName': 'elementDisplayName'}}, 'perFeatureLimit': 1, 'totalResultLimit': 9999, "
                   ...
                   "'suspiciousProcesses']}",
                   "{'queryPath': [{'requestedType': 'Machine', 'filters': [{'facetName': "
                   "'adCanonicalName', 'filterType': 'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': "
                   "'domainFqdn', 'filterType': 'Equals', 'values': ['dl.delivery.mp.microsoft.com']}, {'facetName': "
                   "'lastSeenTimeStamp', 'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], "
                   "'isResult': True}], 'queryLimits': {'groupingFeature': {'elementInstanceType': 'Machine', "
                   "'featureName': 'elementDisplayName'}}, 'perFeatureLimit': 1, 'totalResultLimit': 9999, "
                   ...
                   "{'queryPath': [{'requestedType': 'Machine', 'filters': [{'facetName': "
                   "'elementDisplayName', 'filterType': 'Equals', 'values': ['bcybdw8888w10e2']}, {'facetName': "
                   "'adDNSHostName', 'filterType': 'Equals', 'values': ['dl.delivery.mp.microsoft.com']}, "
                   ...
                   "{'facetName': 'lastSeenTimeStamp', "
                   "'filterType': 'Between', 'values': [1643024885488, 1643025185488]}], "
                   "'isResult': True}], 'queryLimits': {'groupingFeature': {'elementInstanceType': "
                   "'Machine', 'featureName': 'elementDisplayName'}}, 'perFeatureLimit': 1, 'totalResultLimit': 9999, "
                   "'perGroupLimit': 1, 'templateContext': 'CUSTOM', 'customFields': ['elementDisplayName', "
                   "'mountPoints', 'processes', 'services', 'logonSessions', 'hasRemovableDevice', "
                   "'timezoneUTCOffsetMinutes', 'osVersionType', 'platformArchitecture', 'mbrHashString', 'osType', "
    ...
    def test_not_include_filter_query(self):
        ...
        queries = ["{'queryPath': [{'requestedType': 'Connection', 'filters': [{'facetName': 'domainName', "
                   ...
                   "'creationTime', 'filterType': 'Between', 'values': [1642685394609, 1642685694609]}], 'isResult': "
                   "True}], 'queryLimits': {'groupingFeature': {'elementInstanceType': 'Connection', 'featureName': "
                   "'elementDisplayName'}}, 'perFeatureLimit': 1, 'totalResultLimit': 9999, 'perGroupLimit': 1, "
                   ...
                   "'filterType': 'Between', 'values': [1642685394609, 1642685694609]}], 'isResult': True}], "
                   "'queryLimits': {'groupingFeature': {'elementInstanceType': 'Machine', 'featureName': "
                   "'elementDisplayName'}}, 'perFeatureLimit': 1, 'totalResultLimit': 9999, 'perGroupLimit': 1, "
                   "'templateContext': 'CUSTOM', 'customFields': ['elementDisplayName', 'mountPoints', 'processes', "
                   "'services', 'logonSessions', 'hasRemovableDevice', 'timezoneUTCOffsetMinutes', 'osVersionType', "

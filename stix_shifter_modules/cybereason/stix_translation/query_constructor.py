...
class QueryStringPatternTranslator:
    ...
    """
    comparator_lookup = {
        ComparisonExpressionOperators.And: "AND",  # No 'AND' operator,
                                                   # but implemented using filters and connectionFeature
        ComparisonExpressionOperators.Or: "",  # 'OR' Not supported, error will be generated
        ...
        ObservationOperators.Or: '',  # 'OR' Not supported, error will be generated

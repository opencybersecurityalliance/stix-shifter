...
from stix_shifter_utils.stix_translation.src.patterns.pattern_objects import ObservationExpression, \
    ...
    CombinedObservationExpression, ComparisonExpressionOperators, ObservationOperators
...
class QueryStringPatternTranslator:
    ...
    def _parse_expression(self, expression, qualifier=None):
        ...
        if isinstance(expression, ComparisonExpression):  # Base Case
            ...
            query = f"({expression_01} {self.comparator_lookup[expression.operator]} {expression_02})"
            ...
            if isinstance(expression.observation_expression, CombinedObservationExpression):
                ...
                query = f"({exp1} {self.comparator_lookup[expression.observation_expression.operator]} {exp2})"
            ...
            if expression_01 and expression_02:
                return f"({expression_01} {self.comparator_lookup[expression.operator]} {expression_02})"
            elif expression_01:

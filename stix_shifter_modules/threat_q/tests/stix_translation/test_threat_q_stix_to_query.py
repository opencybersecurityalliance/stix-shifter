...
class TestThreatQStixToQuery(unittest.TestCase, object):
    ...
    def test_ipv4_query(self):
        ...
        query = TestThreatQStixToQuery.get_query_translation_result(stix_pattern)
    ...
    def test_multi_observation_expression_query(self):
        stix_pattern = "([ipv4-addr:value = '198.51.100.5'] OR [ipv4-addr:value = '198.51.100.10'])"
        query = TestThreatQStixToQuery.get_query_translation_result(stix_pattern)
        queries = "{'data': '198.51.100.10', 'dataType': 'ip'}"
        _test_query_assertions(query, queries)

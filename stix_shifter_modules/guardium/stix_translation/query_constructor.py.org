...
def translate_pattern(pattern: Pattern, data_model_mapping, options):
    ...
    if data_model_mapping.dialect == 'report':
        ...
        for filter in params:
            filters = None
            n = filter.split(" = ")
            nfilter = "name={0}&value={1}&isGroup=false".format(n[0],n[1])
            if filters == None:
                filters = filters+nfilter
            else:
                filters = filters+"&"+nfilter
        
        return "{\"category\":\"VIOLATION\",\"startTime\":\"20200629 21:00:00\",\"endTime\":\"20200629 23:00:00\", \"filters\"={0}, \"fetchSize\":\"2\"}".format(filters)
...
options_file = open('stix_shifter_modules/qradar_perf_test/tests/stix_translation/qradar_perf_test_stix_to_aql/options.json').read()
selections_file = open('stix_shifter_modules/qradar_perf_test/stix_translation/json/aql_events_fields.json').read()
protocols_file = open('stix_shifter_modules/qradar_perf_test/stix_translation/json/network_protocol_map.json').read()
...
def _parse_query(stix_pattern):
    return translation.translate('qradar_perf_test', 'parse', '{}', stix_pattern)

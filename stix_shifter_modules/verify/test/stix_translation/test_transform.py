...
class TestTransformQuery(unittest.TestCase,object):
    ...
    def get_first_of_type(itr, typ):
        return TestTransformQuery.get_first(itr, lambda o: type(o) == dict and o.get('type') == typ)
    ...
    def test_oca_event(self):
        data = [{"continent_name": "Asia", "city_name": "Kolkata", "country_iso_code": "IN", 
        "ip": "47.15.98.56", "country_name": "India", "region_name": "West Bengal", 
        "location": {"lon": "88.3697", "lat": "22.5697"}, "result": "success", 
        "subtype": "saml", "providerid": "https://portal.baneandox.org:443/SAML20/SP", 
        "origin": "47.15.98.56", "realm": "www.ibm.com",  

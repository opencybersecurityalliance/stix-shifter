...
@patch('googleapiclient._auth.authorized_http')
...
class TestGCPChronicleConnection(unittest.TestCase, object):
    ...
    def test_ping(self, mock_credentials, mock_auth):
        """test ping connection"""
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_code_response = MockCodeResponse(200)
        mock_http.request.return_value = (mock_code_response, json.dumps({"rules": [{"ruleId": "ru_123abcd"}]}))
    ...
    def test_transmit_query(self, mock_credentials, mock_auth):
        ...
        mock_code_response = MockCodeResponse(200)
        mock_query_output_response = json.dumps({"retrohuntId": "oh_1234", "ruleId": "ru_1234", "versionId": "ru_1234",
                                                 ...
                                                 "state": "RUNNING"})
        mocked_create_rule = mock_code_response, json.dumps({"ruleId": "ru_1234"})

        mocked_create_search = (mock_code_response, mock_query_output_response)

        mock_http.request.side_effect = [mocked_create_rule, mocked_create_search]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
    ...
    def test_status_response(self, mock_credentials, mock_auth):
        """test status response """
        search_id = "oh_1234:ru_1234"
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_code_response = MockCodeResponse(200)
        mock_status_output = json.dumps({"retrohuntId": "oh_1234", "ruleId": "ru_1234", "versionId": "ru_1234",
                                         "eventStartTime": "2022-06-28T00:00:00.030Z",
                                         "eventEndTime": "2022-06-29T00:00:00.030Z",
                                         "retrohuntStartTime": "2022-07-07T06:43:40.983372Z",
                                         "retrohuntEndTime": "2022-07-07T06:43:58.750611Z", "state": "DONE",
                                         "progressPercentage": 100})
        mocked_search_status = (mock_code_response, mock_status_output)
        mock_http.request.return_value = mocked_search_status
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
    ...
    def test_delete_response(self, mock_credentials, mock_auth):
        ...
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_http.request.return_value = (MockCodeResponse(200), json.dumps({}))
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        delete_response = transmission.delete(search_id)
        assert delete_response is not None
        assert delete_response['success'] is True

    def test_result_response_with_next_page_token(self, mock_credentials, mock_auth):
        ...
        mocked_delete_response = (MockCodeResponse(200), json.dumps({}))
        mock_http.request.side_effect = [mocked_result_response_1, mocked_result_response_2, mocked_delete_response]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        result_response = transmission.results(search_id, 0, 2)
        assert result_response is not None
        assert result_response['success'] is True
    ...
    def test_invalid_client_email_for_ping(self, mock_credentials, mock_auth):
        """ test invalid  client email for ping"""
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_http.request.side_effect = RefreshError("Invalid Client Email")
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        ping_response = transmission.ping()
        assert ping_response is not None
    ...
    def test_invalid_host_for_ping(self, mock_credentials, mock_auth):
        """ test invalid host for ping"""
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_http.request.side_effect = ServerNotFoundError("Invalid Host")
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        ping_response = transmission.ping()
        assert ping_response is not None
        assert ping_response['success'] is False
    ...
    def test_invalid_client_email_for_transmit_query(self, mock_credentials, mock_auth):
    ...
    def test_invalid_host_for_transmit_query(self, mock_credentials, mock_auth):
    ...
    def test_query_raise_create_rule_query_error(self, mock_credentials, mock_auth):
        ...
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_http.request.return_value = (MockCodeResponse(400), json.dumps({
            "error": {"code": 400,
    ...
    def test_value_error_for_transmit_query(self, mock_credentials, mock_auth):
        ...
        mock_code_response = MockCodeResponse(200)
        mocked_create_rule = (mock_code_response, json.dumps({"ruleId": "ru_1234"}))
        mock_http.request.side_effect = [mocked_create_rule, ValueError("Invalid json")]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        query_response = transmission.query(query)
        assert query_response is not None
        assert query_response['success'] is False
    ...
    def test_transmit_query_with_key_error(self, mock_credentials, mock_auth):
        ...
        mock_http.request.return_value = mocked_create_rule
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        query_response = transmission.query(query)
        assert query_response is not None
        assert query_response['success'] is False
    ...
    def test_query_with_base_exception(self, mock_credentials, mock_auth):
        ...
        mock_code_response = MockCodeResponse(200)
        mocked_create_rule = (mock_code_response, json.dumps({"ruleId": "ru_1234"}))
        mock_http.request.side_effect = [mocked_create_rule, Exception("Unknown Error")]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        query_response = transmission.query(query)
        assert query_response is not None
        assert query_response['success'] is False
    ...
    def test_400_error_with_invalid_timestamp_format(self, mock_credentials, mock_auth):
        ...
        mock_create_search_error_response = (MockCodeResponse(400), json.dumps({
            "error": {"code": 400,
                      "status": "INVALID_ARGUMENT",
                      "message": "Invalid time format"
                      }}))
        mock_http.request.side_effect = [mock_create_rule_response, mock_create_search_error_response]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        query_response = transmission.query(query)
        assert query_response is not None
        assert query_response['success'] is False
    ...
    def test_create_search_with_return_200_and_invalid_response(self, mock_credentials, mock_auth):
        ...
        mock_http = mock_auth.return_value
        mock_create_rule_response = (MockCodeResponse(200), json.dumps({"ruleId": "ru_1234"}))
        mock_create_search_error_response = (MockCodeResponse(200), json.dumps({"Invalid": "Response"}))
        mock_http.request.side_effect = [mock_create_rule_response, mock_create_search_error_response]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        query_response = transmission.query(query)
        assert query_response is not None
    ...
    def test_invalid_query_for_retrohunt_api(self, mock_credentials, mock_auth):
        ...
        mock_http = mock_auth.return_value
        mock_create_rule_response = (MockCodeResponse(200), json.dumps({"ruleId": "ru_1234"}))
        mock_http.request.side_effect = [mock_create_rule_response, ServerNotFoundError("Invalid Host")]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        query_response = transmission.query(query)
        assert query_response is not None
        assert query_response['success'] is False
    ...
    def test_invalid_client_email_for_retrohunt(self, mock_credentials, mock_auth):
        ...
        mock_http = mock_auth.return_value
        mock_create_rule_response = (MockCodeResponse(200), json.dumps({"ruleId": "ru_1234"}))
        mock_http.request.side_effect = [mock_create_rule_response, RefreshError("Invalid Client Email")]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        query_response = transmission.query(query)
        assert query_response is not None
        assert query_response['success'] is False
    ...
    def test_invalid_response_for_400_error_code(self, mock_credentials, mock_auth):
        ...
        mock_code_response = MockCodeResponse(200)
        mocked_create_rule = (mock_code_response, json.dumps({"ruleId": "ru_1234"}))
        mocked_retrohunt_value_error = (MockCodeResponse(400), "Invalid_Response")
        mock_http.request.side_effect = [mocked_create_rule, mocked_retrohunt_value_error]
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        query_response = transmission.query(query)
        assert query_response is not None
        assert query_response['success'] is False
    ...
    def test_timeout_error_in_ping(self, mock_credentials, mock_auth):
        """test connection/timeout error in transmit ping"""
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_http.request.side_effect = TimeoutError("connection attempt failed")
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        ping_response = transmission.ping()
        assert ping_response is not None
        assert ping_response['success'] is False
    ...
    def test_ping_value_error(self, mock_credentials, mock_auth):
        """test value error in transmit ping"""
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_http.request.return_value = (MockCodeResponse(400), "Invalid_Response")
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        ping_response = transmission.ping()
        assert ping_response is not None
        assert ping_response['success'] is False
    ...
    def test_ping_raise_429_error(self, mock_credentials, mock_auth):
    ...
    def test_delete_query_404_error(self, mock_credentials, mock_auth):
        """test 404 error with invalid rule id in transmit delete"""
        search_id = "oh_1234:ru_1234"
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        mock_http.request.return_value = (MockCodeResponse(404),
                                          json.dumps({"error": {
                                              "code": 404,
    ...
    def test_delete_query_with_invalid_client_email(self, mock_credentials, mock_auth):
    ...
    def test_delete_with_server_not_found_error(self, mock_credentials, mock_auth):
    ...
    def test_delete_with_timeout_exception(self, mock_credentials, mock_auth):
    ...
    def test_results_with_invalid_client_email(self, mock_credentials, mock_auth):
    ...
    def test_results_with_invalid_host(self, mock_credentials, mock_auth):
    ...
    def test_results_with_404_error(self, mock_credentials, mock_auth):
    ...
    def test_404_in_next_page_result(self, mock_credentials, mock_auth):
        ...
        mocked_result_response_1 = (mock_code_response, output_1)
        mocked_delete_response = (MockCodeResponse(200), json.dumps({}))
        mocked_result_with_invalid_rule_id = (MockCodeResponse(404), json.dumps({"error": {
            "code": 404,
            "message": "rule with ID ru_1234 could not be found",
            "status": "NOT_FOUND"}}))
        mock_http.request.side_effect = [mocked_result_response_1, mocked_result_with_invalid_rule_id,
    ...
    def test_status_response_with_state_cancelled(self, mock_credentials, mock_auth):
    ...
    def test_status_with_invalid_client_email(self, mock_credentials, mock_auth):
    ...
    def test_status_with_invalid_host(self, mock_credentials, mock_auth):
    ...
    def test_status_response_with_no_state_response(self, mock_credentials, mock_auth):
    ...
    def test_status_response_429_resource_exhausted(self, mock_credentials, mock_auth):
        """status with 429 resource exhausted"""
        search_id = "oh_1234:ru_1234"
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        resource_exhausted_response = json.dumps({'error': {'code': 429,
        ...
        mock_http.request.return_value = mocked_resource_exhausted_response
        transmission = stix_transmission.StixTransmission('gcp_chronicle', self.connection(), self.configuration())
        status_response = transmission.status(search_id)
        assert status_response is not None
        assert status_response['status'] == "RUNNING"

    def test_security_result_response(self, mock_credentials, mock_auth):
    ...
    def test_aws_guardduty_response(self, mock_credentials, mock_auth):
        """test aws guardduty response"""
        search_id = "oh_1234:ru_1234"
        mock_credentials.return_value = None
        mock_http = mock_auth.return_value
        output = json.dumps({
                        ...
                        "references": [{
                            "event": {
                                'metadata': {
                                    ...
                                    'productEventType': 'UnauthorizedAccess:EC2/RDPBruteForce',
                                    'description': 'guardduty',
                                    'ingestedTimestamp': '2022-07-07T07:34:56.380937Z'
                                },
                                'additional': {
                                ...
                                "principal": {
                                    ...
                                    'location': {
                                        ...
                                        'regionLatitude': 37.431572,
                                        'regionLongitude': -78.65689
                                    }
                                },
                                "securityResult": [
                                    {
    ...
    def test_generic_event_with_protocol_response(self, mock_credentials, mock_auth):
    ...
    def test_invalid_email_addresses_response(self, mock_credentials, mock_auth):

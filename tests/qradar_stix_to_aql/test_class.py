...
eventcount as eventcount, PROTOCOLNAME(protocolid) as protocol, payload as payload, URL as url, magnitude as magnitude, Filename as filename, URL as domainname"

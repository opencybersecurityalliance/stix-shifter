...
class TestStixtoQuery(unittest.TestCase, object):
    ...
    def test_url_query(self):
        ...
        translated_query = translation.translate('elastic_ecs', 'query', '{}', stix_pattern)
        translated_query['queries'] = _remove_timestamp_from_query(translated_query['queries'])
        test_query = ['url.full : "http://www.testaddress.com"']
    ...
    def test_query_from_multiple_observation_expressions_joined_by_AND(self):
        ...
        translated_query = translation.translate('elastic_ecs', 'query', '{}', stix_pattern)
        translated_query['queries'] = _remove_timestamp_from_query(translated_query['queries'])
        test_query = ['(url.full : "www.example.com") OR ((source.mac : "00-00-5E-00-53-00" OR destination.mac : "00-00-5E-00-53-00" OR client.mac : "00-00-5E-00-53-00" OR server.mac : "00-00-5E-00-53-00"))']
    ...
    def test_query_from_multiple_comparison_expressions_joined_by_AND(self):
        ...
        translated_query = translation.translate('elastic_ecs', 'query', '{}', stix_pattern)
        translated_query['queries'] = _remove_timestamp_from_query(translated_query['queries'])
        test_query = ['(source.mac : "00-00-5E-00-53-00" OR destination.mac : "00-00-5E-00-53-00" OR client.mac : "00-00-5E-00-53-00" OR server.mac : "00-00-5E-00-53-00") AND (url.full : "www.test.com" OR url.full : "www.example.com")']
        parsed_stix = [{'attribute': 'mac-addr:value', 'comparison_operator': '=', 'value': '00-00-5E-00-53-00'},
    ...
    def test_file_not_equal_query(self):
        ...
        translated_query = translation.translate('elastic_ecs', 'query', '{}', stix_pattern)
        translated_query['queries'] = _remove_timestamp_from_query(translated_query['queries'])
        test_query = ['(NOT process.name : "some_file.exe")']
        parsed_stix = [{'attribute': 'file:name', 'comparison_operator': '!=', 'value': 'some_file.exe'}]
        _test_query_assertions(translated_query, test_query, parsed_stix)

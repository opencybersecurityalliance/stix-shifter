...
from stix_shifter.stix_translation.src.modules.carbonblackprocess import stix_to_cbp

import unittest

translation = stix_translation.StixTranslation()
module = "carbonblackprocess"

class TestStixToCBP(unittest.TestCase, object):
    ...
    def test_file_and_domain_query(self):
        ...
        query = translation.translate(module, 'query', '{}', stix_pattern)
        queries = ["q=hostname:example.com&q=process_name:some_file.exe"]
    ...
    def test_simple_or_query(self):
        ...
        query = translation.translate(module, 'query', '{}', stix_pattern)
        queries = ["q=ipaddr:10.0.0.2 or q=ipaddr:10.0.0.1"]

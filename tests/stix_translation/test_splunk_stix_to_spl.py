...
class TestStixToSpl(unittest.TestCase, object):
    ...
    def test_start_stop_qualifiers(self):
        stix_pattern = "[network-traffic:src_port = 37020] START t'2016-06-01T01:30:00Z' STOP t'2016-06-01T02:20:00Z' OR [ipv4-addr:value = '192.168.122.83'] START t'2016-06-01T03:55:00Z' STOP t'2016-06-01T04:30:00Z'"
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
    ...
    def test_start_stop_qualifiers_one_time(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        queries = 'search (src_port = 37020) earliest="06/01/2016:01:30:00" latest="06/01/2016:02:20:00" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol'

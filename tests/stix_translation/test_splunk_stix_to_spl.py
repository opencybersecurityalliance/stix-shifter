...
class TestStixToSpl(unittest.TestCase, object):
    ...
    def test_ipv4_query(self):
        ...
        print(query)
        queries = '((search (src_ip = "192.168.122.84" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_ip = "192.168.122.84" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) OR (search (src_ip = "192.168.122.83" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_ip = "192.168.122.83" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol))) earliest="{}" | head {}'.format(default_timerange_spl, stix_to_splunk.DEFAULT_LIMIT)
    ...
    def test_ipv6_query(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        queries = '(search (src_ipv6 = "fe80::8c3b:a720:dc5c:2abf%19" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_ipv6 = "fe80::8c3b:a720:dc5c:2abf%19" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="{}" | head {}'.format(default_timerange_spl, stix_to_splunk.DEFAULT_LIMIT)
    ...
    def test_url_query(self):
        ...
        queries = 'search (url = "http://www.testaddress.com" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) earliest="{}" | head {}'.format(default_timerange_spl, stix_to_splunk.DEFAULT_LIMIT)
    ...
    def test_mac_address_query(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        queries = '(search (src_mac = "00-00-5E-00-53-00" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_mac = "00-00-5E-00-53-00" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="{}" | head {}'.format(default_timerange_spl, stix_to_splunk.DEFAULT_LIMIT)
    ...
    def test_domain_query(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        queries = 'search (url = "example.com" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) earliest="{}" | head {}'.format(default_timerange_spl, stix_to_splunk.DEFAULT_LIMIT)
    ...
    def test_query_from_multiple_observation_expressions_joined_by_and(self):
        ...
        queries = 'search (url = "example.com" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR (search (src_mac = "00-00-5E-00-53-00" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_mac = "00-00-5E-00-53-00" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="-5minutes" | head 10000'
    ...
    def test_query_from_multiple_comparison_expressions_joined_by_and(self):
        ...
        queries = '((search (src_mac = "00-00-5E-00-53-00" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_mac = "00-00-5E-00-53-00" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) AND search (url = "example.com" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="-5minutes" | head 10000'
    ...
    def test_file_query(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        print(query)
        queries = 'search (file_name = "some_file.exe" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) earliest="{}" | head {}'.format(default_timerange_spl, stix_to_splunk.DEFAULT_LIMIT)
    ...
    def test_port_queries(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        queries = '(search (dest_port = 23456 | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (src_port = 12345 | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="-5minutes" | head 10000'
    ...
    def test_network_traffic_protocols(self):
        for key, value in protocols.items():
            ...
            query = translation.translate('splunk', 'query', '{}', stix_pattern)
            print(query)
        queries = 'search (protocol = "'+key+'" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) earliest="{}" | head {}'.format(default_timerange_spl, stix_to_splunk.DEFAULT_LIMIT)
    ...
    def test_network_traffic_start_stop(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        queries = '(search (latest = "2018-06-14T08:36:24.000Z" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (earliest = "2018-06-14T08:36:24.000Z" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="-5minutes" | head 10000'
    ...
    def test_start_stop_qualifiers(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        queries = 'search (src_port = 37020 | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) earliest="06/01/2016:01:30:00" latest="06/01/2016:02:20:00" OR (search (src_ip = "192.168.122.83" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_ip = "192.168.122.83" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="06/01/2016:03:55:00" latest="06/01/2016:04:30:00"'
    ...
    def test_issubset_operator(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern)
        queries = '(search (src_ip = "198.51.100.0/24" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_ip = "198.51.100.0/24" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="{}" | head {}'.format(default_timerange_spl, stix_to_splunk.DEFAULT_LIMIT)
    ...
    def test_custom_time_limit_and_result_count(self):
        ...
        print(query)
        queries = '(search (src_ip = "192.168.122.83" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_ip = "192.168.122.83" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol)) earliest="{}" | head {}'.format(timerange_spl, result_limit)
    ...
    def test_custom_mapping(self):
        ...
        query = translation.translate('splunk', 'query', '{}', stix_pattern, options)
        print(query)
        queries = '(search (mac = "00-00-5E-00-53-00" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) AND (search (src_ip = "192.168.122.83" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol) OR search (dest_ip = "192.168.122.83" | fields src_ip, src_port, src_mac, src_ipv6, dest_ip, dest_port, dest_mac, dest_ipv6, file_hash, user, url, protocol))) earliest="{}" | head {}'.format(timerange_spl, result_limit)

...
class TestStixToRelevance(unittest.TestCase, object):
    ...
    def test_process_query(self):
        ...
        stix_pattern = "[process:name = 'node' AND file:hashes.sha256 = '0c0017201b82e1d8613513dc80d1bf46320a957c393b6ca4fb7fa5c3b682c7e5']"
    ...
    def test_file_query(self):
        ...
        stix_pattern = "[file:name = 'a' AND file:parent_directory_ref.path = '/root' OR file:hashes.sha256 = '2584c4ba8b0d2a52d94023f420b7e356a1b1a3f2291ad5eba06683d58c48570d']"
        ...
        parsed_stix = [{'attribute': 'file:hashes.sha256', 'comparison_operator': '=', 'value': '2584c4ba8b0d2a52d94023f420b7e356a1b1a3f2291ad5eba06683d58c48570d'}, {'attribute': 'file:parent_directory_ref.path', 'comparison_operator': '=', 'value': '/root'}, {'attribute': 'file:name', 'comparison_operator': '=', 'value': 'a'}]
        print(query)
        assert query == {'queries': queries, 'parsed_stix': parsed_stix}
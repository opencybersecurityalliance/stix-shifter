...
class TestStixToSpl(unittest.TestCase, object):
    ...
    def test_unmapped_attribute(self):
        ...
        self.assertRaises(data_mapping_exception, lambda: shifter.translate('splunk', 'query', '{}', stix_pattern))
    
    def test_invalid_stix_pattern(self):
        stix_pattern = "[not_a_valid_pattern]"
        self.assertRaises(Exception, lambda: shifter.translate('splunk', 'query', '{}', stix_pattern))

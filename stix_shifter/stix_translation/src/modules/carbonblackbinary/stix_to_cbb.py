...
class StixToCBB(BaseQueryTranslator):
    ...
    def transform_query(self, data, options, mapping=None):
        ...
        :type data: str
        :param mapping: The mapping file path to use as instructions on how to transform the given STIX query into cbquery format. This defaults to the from_stix_map.json in the stix_shifter/src/modules/carbonblackbinary/json/ directory
